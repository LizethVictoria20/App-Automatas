...
export const busyBeaver3: TMConfig = {
  ...
  transitions: [
    ...
    { currentState: "B", readSymbol: "1", writeSymbol: "1", move: "R", nextState: "B" },
    
    // Estado C
    { currentState: "C", readSymbol: "_", writeSymbol: "1", move: "L", nextState: "B" },
    { currentState: "C", readSymbol: "1", writeSymbol: "1", move: "R", nextState: "halt" },
  ],
};
